...
function Platform() {
	...
	if (score >= 5000) this.types = [4, 4, 4, 4, 4, 4, 4, 4];
	else if (score >= 2000 && score < 5000) this.types = [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4];
	else if (score >= 1000 && score < 2000) this.types = [4, 4, 4, 4, 4, 4, 4, 4];
	else if (score >= 500 && score < 1000) this.types = [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, ];
